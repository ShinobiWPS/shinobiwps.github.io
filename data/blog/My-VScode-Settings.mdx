...
<div className="-mx-2 flex flex-wrap overflow-hidden xl:-mx-2">
  ...
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:px-2">
    ![Profiles settings](/static/images/vscode-settings/profiles-settings.png)
  </div>
...
- By keeping the default profile icon, it shows first 2 letters of its name (instead of remembering an icon)
- By defaulting the Keybindings and Settings, it allows for easy edit and maintenance.
